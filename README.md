...
- **[daily-code](https://www.npmjs.com/package/daily-code)** - Reuse casual utilities
- **[uni-run](https://www.npmjs.com/package/uni-run)** - Run all kind of code
- **[one-time-jwt](https://www.npmjs.com/package/one-time-jwt)** - One-time use JWT tokens
- **[css-wrapper](https://wrapper.sayad.dev)** - CSS utility wrapper. Visual css wrapper generator
- **[auto-fold](https://marketplace.visualstudio.com/items?itemName=NazmusSayad.auto-fold)** - VS Code extension for auto folding
