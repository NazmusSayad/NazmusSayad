...
- **[npmize](https://www.npmjs.com/package/npmize)** - A tool to create npm packages easily
- **[noarg](https://www.npmjs.com/package/noarg)** - A argument parser for nodejs, simple and easy to use
- **[netserv](https://www.npmjs.com/package/netserv)** - Serve your files over the local network
- **[rype](https://www.npmjs.com/package/rype)** - A type checking library for javascript, perfectly typed
- **[react-net-kit](https://www.npmjs.com/package/react-net-kit)** - Make usages of fetch/http easier with the help of axios
